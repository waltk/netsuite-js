...
var searchName = 'onHand';
console.log('Creating NetSuite connection');
//var wsJSON = fs.createWriteStream(String('\\\\SERVER01\\Server\\Operations\\Materials\\Purchasing Forecast\\NetsuiteData\\JSON\\onHand.json'));
service
  ...
  .then(function( /*client*/ ) {
    ...
    search.savedSearchId = '344';

    console.log('Performing SearchAdvanced onHand');
