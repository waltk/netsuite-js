...
var searchName = 'workOrders';
console.log('Creating NetSuite connection');
//var wsJSON = fs.createWriteStream(String('\\\\SERVER01\\Server\\Operations\\Materials\\Purchasing Forecast\\NetsuiteData\\JSON\\workOrders.json'));
...
service
  ...
  .then(function( /*client*/ ) {
    ...
    search.savedSearchId = '362';

    console.log('Performing SearchAdvanced workOrders');
