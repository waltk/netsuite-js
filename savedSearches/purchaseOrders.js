...
var searchName = 'purchaseOrders';
console.log('Creating NetSuite connection');
//var wsJSON = fs.createWriteStream(String('\\\\SERVER01\\Server\\Operations\\Materials\\Purchasing Forecast\\NetsuiteData\\JSON\\purchaseOrders.json'));
...
service
  ...
  .then(function( /*client*/ ) {
    ...
    console.log('Performing SearchAdvanced purchaseOrders');
