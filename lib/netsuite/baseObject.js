...
BaseObject.prototype.getSerializableArrayPropertyNames = function() {
  return [];
};

BaseObject.prototype.getXmlFromArrayProperty = function (propertyName) {
  var xml = '';
  if (this[propertyName] && Array.isArray(this[propertyName]) && this[propertyName].length) {
    var property = this[propertyName];
    var ns = this.getNS();
    var prefix = ns ? (ns.key + ':') : '';
