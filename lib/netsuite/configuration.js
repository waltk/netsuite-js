...
var _ = require('lodash'),
  ...
  setGlobalOptions = require('./options').set;
/**
 ...
 * @param {String} credentials.webservicesDomain NetSuite soap domain url
 * @param {String} credentials.applicationId NetSuite applicationId
...
var Configuration = module.exports = function Configuration(credentials, options) {
  ...
  // Default
  this._webservicesDomain = this.credentials.webservicesDomain || "https://webservices.na2.netsuite.com";
};
...
Configuration.prototype._resolveWsdl = function() {
  ...
  //this._wsdl = '//wsdl/v' + this.options.apiVersion + '_0/netsuite.wsdl';
  //this._wsdl = 'C:\\Users\\WKuhn\\Projects\\netsuite-js\\wsdl\\v2015_1_0\\netsuite.wsdl'
...
Configuration.prototype.createConnection = function(skipDiscovery) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    if (_this.credentials && !_this.credentials.restUrl || skipDiscovery) {
